...
(
	function()
	{
		...
		この型.開始する = function( ドキュメント )
		{
			...
			let モーター = 音響群.純音の型.作成( 音響文脈, 全音量振幅器 );
			let ファン = 音響群.純音の型.作成( 音響文脈, 全音量振幅器 );
			let ギア = 音響群.純音の型.作成( 音響文脈, 全音量振幅器 );
			...
			function 定期更新()
			{
				...
				モーター.周波数を設定( 動力.モーター周波数.値 * 4, 目標時刻 );
				ファン.周波数を設定( 動力.ファン周波数.値, 目標時刻 );
				ギア.周波数を設定( 動力.噛み合い周波数.値, 目標時刻 );
			}
