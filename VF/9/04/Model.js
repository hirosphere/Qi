...
(
	function()
	{
		...
		この典型.動力選択が更新 = function( 名称 )
		{
			...
			この実体.列車.動力.整流子数.値を設定( 項目[ 2 ] );
			この実体.列車.動力.車輪径.値を設定( 項目[ 3 ] );
			この実体.列車.加速度減衰率.値を設定( 項目[ 4 ] );
			この実体.表題.値を設定( 項目[ 5 ] );
		};

		この典型.動力設定リスト =
		{
			"15-91": [ 15, 91, 42, 910, 0.65, "国鉄103系" ],
			"16-91": [ 16, 91, 42, 860, 0.55, "東武8000系" ],
			"17-82": [ 17, 82, 42, 860, 0.55, "国鉄115系" ],
			"19-80": [ 19, 80, 42, 860, 0.50, "国鉄165系" ],
			"22-77": [ 22, 77, 42, 860, 0.45, "国鉄485系" ],
		};
