...
void App::Setup()
{
	...
	trains[ 0 ].Set_Schedule( "S 90 3.3, W 5, S 0 3.3, W 5, R, W 5" );
	trains[ 1 ].Set_Schedule( "S 90 3.0, W 5, S 0 3.0, W 5, R, W 5" );
	trains[ 2 ].Set_Schedule( "S 90 2.8, W 5, S 0 2.8, W 5, R, W 5" );
	trains[ 3 ].Set_Schedule( "S 90 2.3, W 5, S 0 2.3, W 5, R, W 5" );
