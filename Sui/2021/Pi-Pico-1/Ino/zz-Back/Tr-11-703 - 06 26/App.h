...
struct Powers
{
	struct Writer
	{
		...
		inline void operator = ( float value ) { operator = ( ( int16_t ) ( value * PWM_Range_f ) ); }
		...
		inline explicit operator bool() { return ct --; }
...
struct Train : public Fields, public Powers::Renderer
{
	Float Speed;
	Float Idle, Bias, Max;
	int dir = 1;

	struct WG1 : public Wave_Gen { void Render( Train & train, Powers::Writer writer ); } wg1;
