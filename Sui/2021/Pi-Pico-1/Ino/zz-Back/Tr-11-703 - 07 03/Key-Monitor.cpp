...
String App::Key_Monitor::Act( char key )
{
	switch( key )
	{
		...
		case 'g':  field_sel = "VF-Type";  break;
		case 'h':  field_sel = "Freq";  break;
		case 'j':  field_sel = "Width";  break;
		case 'k':  field_sel = "Param-1";  break;
		case 'l':  field_sel = "Null";  break;
		...
		case '1':  return app.monitor_string();  break;
	}
