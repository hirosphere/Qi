	...
	(
		...
		function()
		{
			...
			this.ConnectModel = function()
			{
				...
				this.model.Playing.AddView( function() { self.UpdatePlaying(); } );
				this.model.Wave.AddView( function() { self.UpdateWave(); } );

				let paramView = function() { self.UpdateParams(); };
