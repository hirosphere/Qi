...
(
	...
	function()
	{
		...
		this.BuildHoriz1 = function( com, args, model )
		{
			...
			new SliderInput( vert, { Width: -1, Height: 25, Text: "音量", Value: model.Volume } );
			new SliderInput( vert, { Width: 01, Height: 25, Text: "倍速", Value: model.Rate } );
		...
		this.BuildHoriz2 = function( com, args, model )
		{
			...
			{
				let vert = new VertPane( horiz, { Width: 290, Height: -1, Sep: 2 } );
				vert.e.style.zIndex = 1;
				
				new SliderInput( vert, { Width: -1, Height: 25, Text: "NSパン", Value: model.NS_Pan } );
				new SliderInput( vert, { Width: -1, Height: 25, Text: "EWパン", Value: model.EW_Pan } );
				new SliderInput( vert, { Width: -1, Height: 25, Text: "UDパン", Value: model.UD_Pan } );
			}
